        ...
        <div className="relative w-full mx-auto mt-32 mb-16">
            ...
            >
                ...
                <div className="flex-shrink-0 overflow-hidden rounded-lg shadow-lg w-80 bg-gray-50">
                    <img
                        src={`${import.meta.env.BASE_URL}captura_2.png`}
                 ...
                 <div className="flex-shrink-0 overflow-hidden rounded-lg shadow-lg w-80 bg-gray-50">
                    <img
                        src={`${import.meta.env.BASE_URL}captura_1.png`}
                        alt="Vocaliza y Aprende"
                        className="object-cover w-full h-48"
                    />
                    <div className="py-3 text-center text-white bg-gray-800">
                ...
                <div className="flex-shrink-0 overflow-hidden rounded-lg shadow-lg w-80 bg-gray-50">
                    <img
                        src={`${import.meta.env.BASE_URL}captura_8.png`}
                        alt="Vocaliza y Aprende"
                        className="object-cover w-full h-48"
                    />
                    <div className="py-3 text-center text-white bg-gray-800">
                ...
                <div className="flex-shrink-0 overflow-hidden rounded-lg shadow-lg w-80 bg-gray-50">
                    <img
                        src={`${import.meta.env.BASE_URL}captura_10.png`}
                        alt="Vocaliza y Aprende"
                        className="object-cover w-full h-48"
                    />
                    <div className="py-3 text-center text-white bg-gray-800">
                ...
                <div className="flex-shrink-0 overflow-hidden rounded-lg shadow-lg w-80 bg-gray-50">
                    <img
                        src={`${import.meta.env.BASE_URL}captura_9.png`}
                ...
                <div className="flex-shrink-0 overflow-hidden rounded-lg shadow-lg w-80 bg-gray-50">
                    <img
                        src={`${import.meta.env.BASE_URL}captura_6.png`}
                        alt="Otro Proyecto"
                        className="object-cover w-full h-48"
                    />
                    <div className="py-3 text-center text-white bg-gray-800">
                 ...
                 <div className="flex-shrink-0 overflow-hidden rounded-lg shadow-lg w-80 bg-gray-50">
                    <img
                        src={`${import.meta.env.BASE_URL}captura_5.png`}
                        alt="Otro Proyecto"
                        className="object-cover w-full h-48"
                    />
                    <div className="py-3 text-center text-white bg-gray-800">
                ...
                <div className="flex-shrink-0 overflow-hidden rounded-lg shadow-lg w-80 bg-gray-50">
                    <img
                        src={`${import.meta.env.BASE_URL}captura_7.png`}
